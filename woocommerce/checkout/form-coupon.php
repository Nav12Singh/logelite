...
// Overridden by logelite — reason: adds lgl-checkout-coupon classes for
// restyling (right column, see assets/css/pages/checkout.css and
// woocommerce/checkout/form-checkout.php's grid comment). The
// wc_coupons_enabled() gate, the showcoupon toggle link/aria-controls
// pairing, and the form itself are unchanged. Note: this template has no
// nonce field of its own — checkout coupon application submits via
// WooCommerce's own AJAX (wc-ajax=apply_coupon), whose nonce is
// localized separately in core JS, untouched here.
