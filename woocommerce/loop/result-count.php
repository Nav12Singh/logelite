...
// Overridden by logelite — reason: adds an lgl-* class so this can be
// restyled to match design-reference's toolbar ("Showing 1–10 of 913
// results") via assets/css/pages/shop.css. Logic is otherwise unchanged
// from upstream — called directly from woocommerce/archive-product.php's
// toolbar (woocommerce_result_count()), not from the default
// woocommerce_before_shop_loop hook, which was removed in
// inc/woocommerce.php.
...
?>
<p class="woocommerce-result-count lgl-shop-result-count" role="status" aria-relevant="all" <?php echo ( empty( $orderedby ) || 1 === intval( $total ) ) ? '' : 'data-is-sorted-by="true"'; ?>>
	<?php
