...
<div class="lgl-cart-layout">
	<div class="lgl-cart-layout__items">
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			...
			<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents lgl-cart-table" cellspacing="0">
				<thead>
					<tr>
								...
								<td class="product-remove">
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												'<a role="button" href="%s" class="remove lgl-cart-remove" data-product_id="%s" data-product_sku="%s">'
													. '<svg width="14" height="14" viewBox="0 0 14 14" aria-hidden="true" focusable="false"><line x1="1" y1="1" x2="13" y2="13" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"></line><line x1="13" y1="1" x2="1" y2="13" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"></line></svg>'
													. '<span class="lgl-visually-hidden">%s</span>'
													. '</a>',
												esc_url( wc_get_cart_remove_url( $cart_item_key ) ),
												esc_attr( $product_id ),
												esc_attr( $_product->get_sku() ),
												/* translators: %s is the product name */
												esc_html( sprintf( __( 'Remove %s from cart', 'woocommerce' ), wp_strip_all_tags( $product_name ) ) )
											),
											$cart_item_key
										);
									?>
	...
	<div class="cart-collaterals lgl-cart-layout__totals">
		<?php
			/**
