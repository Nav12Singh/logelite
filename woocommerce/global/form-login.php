...
// restyling via assets/css/pages/checkout.css. The woocommerce-login-nonce
// field and every action are unchanged.
...
?>
<form class="woocommerce-form woocommerce-form-login login lgl-checkout-card" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
